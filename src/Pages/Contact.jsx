...
export default function Contact() {
    ...
    const contactDetails = [
        {
            label: 'Email',
            value: 'atulthakur5103@gmail.com',
        ...
        {
            label: 'Instagram',
            value: 'atulsinghthakur.27',
            icon: <Instagram className="w-6 h-6" />,
            link: 'https://instagram.com/atulsinghthakur.27',
            color: 'from-pink-600 to-orange-400'
        },
        {
            label: 'GitHub',
            value: 'github.com/AtulThakur27',
        ...
        {
            label: 'LinkedIn',
            value: 'linkedin.com/in/https://www.linkedin.com/in/atul-thakur-84708b2bb',
